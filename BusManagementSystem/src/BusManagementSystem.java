...
public class BusManagementSystem {
	...
	public static void home() {
		...
		System.out.printf("\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\"
				...
				+ "Enter 'quit' to quit \n"
				+ "\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\n");
		if(input.hasNext("1")) stopSearch();
		else if(input.hasNext("2")) tripSearch();
		else if(input.hasNext("3"))	shortestPath();
		else if(input.hasNext("quit")) quit = true;
	...
	public static void shortestPath() {
		...
		while(!valid)
		{
			System.out.println("Enter the starting stop ID:");
			start = input.nextInt();
			...
			if(!(g.contains(start) && g.contains(end)))
			{
				System.out.println("Error:" + 
					((!g.contains(start) && !g.contains(end)) ? (start + "and" + end + "are not valid stop IDs") 
					: !g.contains(start) ? (start + "is not a valid stop ID") 
					: (end + "is not a valid stop ID")));
				System.out.printf("Enter 'r' if you would like to try again /n"
						+ "Enter 'quit' to quit");
			...
			{
				valid = true;
				if(!g.Djikstra(start, end))
				{
					System.out.println("No Route Found");
				}
			}
		}
		System.out.printf("Enter 'r' if you would like to enter different inputs /n"
